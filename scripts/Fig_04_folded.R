...
#png("~/urchin_af/figures/folded_maf.png", height=85, width=85, units="mm", res=300)
...
#lines(density(mydata$D1_8_maf), col=alpha("black", 1), lwd=3)
...
png("~/urchin_af/figures/maf_vs_afchange.png", height=85, width=85, units="mm", res=300)
