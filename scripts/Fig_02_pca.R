...
pc_sum$PC1[13] <- (pc_sum$PC1[13]+ pc_sum$PC1[13]*.7)
...
sp <- c(21,24, 21,24)
bg.col <-  c("firebrick3", "firebrick3","gray40","gray40")
...
title(xlab="PC1: 7.2%", line=2, cex.lab=1.05)
title(ylab="PC2: 6.6%", line=2, cex.lab=1.05)

legend("topleft", pch=c(21,21,24,24), 
    pt.bg=c("gray40", "firebrick3", "gray40", "firebrick3") ,
    legend=c("Day 1 pH 8.0", "Day 1 pH 7.5", "Day 7 pH 8.0", "Day 7 pH 7.5" ),
    pt.cex=1.6, cex=0.85)
dev.off()
