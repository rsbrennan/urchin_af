...
#convert to pileup:
samtools mpileup ~/urchin_af/variants/D1.sort.bam > ~/urchin_af/variants/D1_8.sort.pileup
samtools mpileup ~/urchin_af/variants/D7_8.sort.bam > ~/urchin_af/variants/D7_8.sort.pileup
samtools mpileup ~/urchin_af/variants/D7_7.sort.bam > ~/urchin_af/variants/D7_7.sort.pileup
